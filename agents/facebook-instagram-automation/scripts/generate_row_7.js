...
const RANGE = 'Ảnh câu hỏi scale!A7:K7'; 
...
async function generateRow7() {
    try {
        ...
        const domain = row[1];
        const content = row[2];
        const topic = row[5] || 'Situational Judgment'; // Title column
        ...
        let reference = '';
        let refSource = 'Process Groups Practice Guide';
        ...
        const outputPath = path.resolve(__dirname, '../post_row_7.png');
